package com.alibaba.datax.plugin.write.oscarwriter;
...
public class OscarWriter extends Writer {
    ...
    static {
    	//加载插件下面配置的驱动类
        DBUtil.loadDriverClass("writer", "oscar");
    }
...
//            }
            ...
            this.commonRdbmsWriterMaster = new SubCommonOscarWriter.Job(
                    DATABASE_TYPE);
    ...
    public static class Task extends Writer.Task {
        ...
        public void init() {
            ...
            this.commonRdbmsWriterSlave = new SubCommonOscarWriter.Task(
                    DATABASE_TYPE);
