...
public class CommonRdbmsWriter {
    ...
    public static class Task {
        ...
        public void startWriteWithConnection(RecordReceiver recordReceiver, TaskPluginCollector taskPluginCollector, Connection connection) {
            ...
            if (this.dataBaseType == DataBaseType.Oracle || this.dataBaseType ==DataBaseType.RDBMS || this.dataBaseType ==DataBaseType.Oscar) {
            ...
            try {
                ...
                while ((record = recordReceiver.getFromReader()) != null) {
                    if (record.getColumnNumber() != this.columnNumber && this.dataBaseType != DataBaseType.Oracle && this.dataBaseType != DataBaseType.RDBMS && this.dataBaseType != DataBaseType.Oscar) {
        ...
        protected void doBatchInsert(Connection connection, List<Record> buffer)
            ...
            try {
                ...
                // guojun add and replace in 2021/01/04(startsWith("update"))
                if ((this.dataBaseType == DataBaseType.Oracle || this.dataBaseType == DataBaseType.RDBMS || this.dataBaseType == DataBaseType.Oscar) &&
                        this.writeMode.trim().toLowerCase().startsWith("update"))  {
                    String merge = this.writeMode;
                    String[] sArray = WriterUtil.getStrings(merge);
